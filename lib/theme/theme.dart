...
class MaterialTheme {
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onPrimaryFixed: Color(0xffffffff),
      primaryFixedDim: Color(0xff113b0f),
      onPrimaryFixedVariant: Color(0xffffffff),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      surfaceTint: Color(0xffa3d398),
      onPrimary: Color(0xff022d04),
      primaryContainer: Color(0xff6f9c66),
      ...
      primaryFixedDim: Color(0xffa3d398),
      onPrimaryFixedVariant: Color(0xff153e13),
      secondaryFixed: Color(0xffd6e8ce),
